...
void getacidVoltages(float & acidbattery)
{
   acidbattery = getADCVoltage(channel_VEXT2_ADC) * BATT_VFACTOR;
}
...
//!   getacidVoltages(acidbattery);
//!      //fprintf(PC,"source = %2.6f\n",acidbattery);
//!      //source = batExt_adc(7);
//!   
//!   if (displayDirect==1)
//!   {
//!      fprintf(PC,"lead acid = %2.3f\n",acidbattery);
//!      return 0;
//!   } 
...
//!      if (acidbattery <= 11.89){
//!         return 3;}
   if ((primary <= 3.4) && (secondary <= 3.4))
      return 3;
